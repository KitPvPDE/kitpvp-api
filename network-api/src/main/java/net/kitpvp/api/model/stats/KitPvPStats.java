...
public interface KitPvPStats {
    ...
    LongStageKey<String> KITPVP_KILLS_WITH_KIT =
            LongStatsKey.<String>builder().keyBuilder(builder -> builder.prefix("kitpvp.stats").function(Function.identity()).suffix("kills")).stage();
    LongStageKey<String> KITPVP_DEATHS_WITH_KIT =
            LongStatsKey.<String>builder().keyBuilder(builder -> builder.prefix("kitpvp.stats").function(Function.identity()).suffix("deaths")).stage();
    LongStageKey<String> KITPVP_KILLSTREAK_WITH_KIT =
            LongStatsKey.<String>builder().keyBuilder(builder -> builder.prefix("kitpvp.stats").function(Function.identity()).suffix("killstreak")).stage();
    LongStageKey<String> KITPVP_SPECIAL_ACTION_WITH_KIT =
            LongStatsKey.<String>builder().keyBuilder(builder -> builder.prefix("kitpvp.stats.").function(Function.identity()).suffix("value")).stage();
